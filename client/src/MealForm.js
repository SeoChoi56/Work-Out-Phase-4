...
function MealForm( { getMeals }) {
  ...
  function getMealFromCard(meal){
    console.log("this is from meal form");
    getMeals(meal)
  }
  ...
  return (
    <div className="font-bold justify-center items-center p-10 flex flex-col max-h-max font-mono bg-[url('/public/image.png')]">
